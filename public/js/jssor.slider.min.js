(function (j, h, c, g, d, k, f) {
    ...
    var b = (j.$Jssor$ = new (function () {
        ...
        function Ib() {
            if (!O) {
                ...
                if (E.pointerEnabled || (a = E.msPointerEnabled))
                    O.Ed = a ? "msTouchAction" : "touchAction";
            }
            return O;
        }
        function w(g) {
        ...
        function s(h, l) {
            ...
            s = function (e, c) {
                ...
                if (c.Ce)
                    if (d) yb(i.$CreateCallback(g, R, e, c));
                    else a(e, c);
            };
            i.nc = R;
            if (d) i.nc = s;
        ...
        i.yc = function (c, d) {
            ...
            if (c)
                if (b.dd(c)) a = { V: a };
                else if (b.dd(c.$Clip)) a.$Clip = { V: c.$Clip };
            a.V = a.V || d;
    ...
    var m = { Eb: "data-scale", Ec: "data-scale-ratio", wb: "data-autocenter" },
        n = new (function () {
            var a = this;
    ...
    j.$JssorThumbnailNavigator$ = function (f, E) {
        ...
        r.Nc = function (G, H) {
            if (!C) {
                ...
                j =
                    j || c.ceil(((B + l) / (t + l)) * g + ((z + q) / (s + q)) * (1 - g));
                j = c.min(j, A);
                var w = t + (t + l) * (e - 1) * (1 - g),
                    p = s + (s + q) * (e - 1) * g,
                    n = w + (w + l) * (j - 1) * g,
    ...
    j.$JssorCaptionSlideo$ = function (v, k, u, E) {
        ...
        function q(d, c) {
            ...
            b.$Each(d, function (d, f) {
                var e = n[f];
                if (e) {
                    if (b.vd(d)) d = q(d, c || f == "e");
                    else if (c) if (b.ic(d)) d = w[d];
                    a[e] = d;
                }
            });
            return a;
        ...
        function z(t, u, h) {
            ...
            b.$Each(u, function (i) {
                ...
                var o = { $Easing: j, $OriginalWidth: h.v, $OriginalHeight: h.u },
